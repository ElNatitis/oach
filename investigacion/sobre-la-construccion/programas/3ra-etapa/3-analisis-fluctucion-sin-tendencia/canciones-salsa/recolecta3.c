...
int main()
{
  ...
  int numero_de_semidifusas = 5872;
  
  char ruta[512]; // para almacenar la ruta del directorio actual
  char archivo[] = "héctor-lavoe---plazos-traicioneros-(karaoplay.com)-norm.csv";  // nombre del archivo a analizar
  ...
  int* segmentos; 
  float* final;
  segmentos = calloc(3,sizeof(int)); // arreglo de 3 elementos donde cada elemento es un numero entero 
