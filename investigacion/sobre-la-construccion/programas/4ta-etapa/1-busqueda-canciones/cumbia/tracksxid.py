...
genero = 'cumbia' # genero con el que se está trabajando
...
bd = pd.read_csv('lanzamientos-unicos-cumbia.csv') # Tomar el csv
...
canciones_unicas.to_csv(f'canciones-de-{genero}.csv', index=False)
